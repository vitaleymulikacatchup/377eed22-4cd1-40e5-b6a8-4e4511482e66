...
export const metadata: Metadata = {
  title: "Pandas Flowers Studio - Artisan Floral Arrangements",  description: "Premium handcrafted flower arrangements for every occasion. Fresh, beautiful designs created by expert florists. Order custom bouquets today.",  keywords: "flower delivery, floral arrangements, custom bouquets, fresh flowers, florist, premium flowers, wedding flowers, event florals",  metadataBase: new URL("https://pandasflowers.com"),
  alternates: {
    canonical: "https://pandasflowers.com"
  },
  openGraph: {
    title: "Pandas Flowers Studio - Premium Artisan Floristry",    description: "Handcrafted flower arrangements for weddings, events, and special occasions.",    url: "https://pandasflowers.com",    siteName: "Pandas Flowers Studio",    type: "website",    images: [
      {
        url: "https://img.b2bpic.net/free-photo/beautiful-bouquet-lilacs-roses-standing-rustic-hence-vase_114579-1849.jpg",        alt: "Pandas Flowers Studio premium floral arrangement"
      }
    ]
  },
  twitter: {
    card: "summary_large_image",    title: "Pandas Flowers Studio",    description: "Artisan floral arrangements crafted with passion and precision.",    images: ["https://img.b2bpic.net/free-photo/beautiful-bouquet-lilacs-roses-standing-rustic-hence-vase_114579-1849.jpg"]
  },
  robots: {
    index: true,
    follow: true
